...
func TestOverwriteValue_Unmarshal(t *testing.T) {
    scenarios := []struct {
        desc string
        test func(t *testing.T)
    }{
        {
            desc: "non-pointer input",
            test: func(t *testing.T) {
                input := struct{}{}
                ...
                err := sv.Unmarshal(input)

                assert.Equal(t, ErrPointerArgumentRequired, err)
            },
        },
        {
        ...
        },
        {
            ...
            test: func(t *testing.T) {
                ...
                assert.Nil(t, err)
                assert.Equal(t, &dummy{"test"}, input)
            },
        },
    }
